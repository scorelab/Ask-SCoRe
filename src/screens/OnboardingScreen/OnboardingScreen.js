...
const OnboardingScreen = ({navigation}) => {
    return (
        ...
        pages={[
          {
            backgroundColor: '#fff',
            image: <Image style={styles.ImageView1} source={require('../../../assets/OB1.png')} />,
          ...
          {
            backgroundColor: '#fff',
            image: <Image style={styles.ImageView2} source={require('../../../assets/OB2.png')} />,
            title: <Text style={styles.titleView}>Collaboration</Text>,
            subtitle: <Text style={styles.subtitleView}>Collaborate and sync on Projects</Text>,
          },
          {
            backgroundColor: '#fff',
            image: <Image style={styles.ImageView3} source={require('../../../assets/OB3.png')} />,
            title: <Text style={styles.titleView}>Communicate</Text>,
            subtitle: <Text style={styles.subtitleView}>Communication is what makes team strong</Text>,
          },
          {
            backgroundColor: '#fff',
            image: <Image style={styles.ImageView4} source={require('../../../assets/OB4.png')} />,
            title: <Text style={styles.titleView}>Queries</Text>,
            subtitle: <Text style={styles.subtitleView}>Get your queries Resolved</Text>,
          },
        ]}
      />
    );
